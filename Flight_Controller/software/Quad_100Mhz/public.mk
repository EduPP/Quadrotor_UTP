...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../Quad.jdi
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x40021e8
SOPC_SYSID_FLAG += --sidp=0x40021e8
ELF_PATCH_FLAG  += --sidp 0x40021e8

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1472580455
SOPC_SYSID_FLAG += --timestamp=1472580455
ELF_PATCH_FLAG  += --timestamp 1472580455
