...
/*************** Controlador Lazo Interno *********************/
 ...
 void SetPoints()
 {
	...
	sp_roll = roundf(RF1*0.0299 - 88.6834)+0.5; //ecuacion corregida para desviacion 0.5
	sp_pitch = (-1)*roundf(RF3*0.0298 - 88.5060)-1.0; //ecuacion negativay corregida con desviacion 1°
